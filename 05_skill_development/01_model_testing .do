...
//----------------------------------------------------------------------------//
// Average over raters and lessons for each subdomain
//----------------------------------------------------------------------------//
...
mat mu0 = _b[x1:1.treat],_b[x2:1.treat],_b[x3:1.treat],_b[x4:1.treat],_b[x5:1.treat]
mat mu1 = _b[x1:2.treat],_b[x2:2.treat],_b[x3:2.treat],_b[x4:2.treat],_b[x5:2.treat]
...
sem (F1 -> x1 x2@1 x5) (F2 -> x3 x4)  (F2 <- F1) , group(treat) var(/*e.x2@0*/ e.x3@0) ginvariant(mcoef scoef) means(F1@0)	//standardized		 
